...
2. Summary: A concise summary (10-500 characters) of the main content
3. Keywords: 1-20 relevant keywords extracted from the content
...
Return the output strictly as a valid JSON object. Do not include markdown formatting or backticks."""
        ...
        if categories:
            ...
            user_prompt = f"""Identify the category from this list: [{categories_str}] and provide a summary for this link content: {url}

{html_preview}

Return JSON with 'category', 'summary', and 'keywords' fields."""
        else:
